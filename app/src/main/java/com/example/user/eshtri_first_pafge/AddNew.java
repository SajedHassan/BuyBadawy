...
public class AddNew extends AppCompatActivity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, array.categories,
		...
		add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				addNewProductThread.execute(task, MainActivity.activeUser, nameVal, catVal, detailsVal, propertiesVal,
						addressVal, priceVal);
			}
		});
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == AddNew.RESULT_LOAD_IMAGE && resultCode == Activity.RESULT_OK && null != data) {
