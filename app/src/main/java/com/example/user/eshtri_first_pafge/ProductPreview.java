...
public class ProductPreview extends AppCompatActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		Intent clickedItem = this.getIntent();
		...
		// F stands for field
		ImageView imageView = (ImageView) this.findViewById(id.myp_roduct_image);
		TextView nameF = (TextView) this.findViewById(id.product_name);
		TextView phoneF = (TextView) this.findViewById(id.num);
		TextView addressF = (TextView) this.findViewById(id.address);
		TextView priceF = (TextView) this.findViewById(id.price);
		TextView detF = (TextView) this.findViewById(id.details);
		TextView proF = (TextView) this.findViewById(id.dec);
		TextView ownerF = (TextView) this.findViewById(id.owner);
